...
const BOOKING_ORIGINS = new Set([
  ...
  'https://preview.webcake.io'
]);

function isAllowedBookingOrigin(origin) {
  if (BOOKING_ORIGINS.has(origin)) return true;
  try {
...
module.exports = { allowBookingCors, assertAdmin, assertMethod, handleError, isAllowedBookingOrigin, readJson, sendJson };
